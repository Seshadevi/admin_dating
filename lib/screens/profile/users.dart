...
// Import your DatingColors & AppThemes
...
class _UsersScreenState extends State<UsersScreen>
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      height: 36,
                      decoration: BoxDecoration(
                          color: DatingColors.darkGreen, // Use your palette
                          shape: BoxShape.rectangle,
                          borderRadius: BorderRadius.circular(8)
                      ),
                      child: const Icon(Icons.add, color: Colors.white),
                        ...
                        children: [
                          Text("7 Hr 32m",
                              style: theme.textTheme.headlineMedium?.copyWith(
                                  fontWeight: FontWeight.bold)),
                          const SizedBox(height: 12),
                          _buildStatItem(DatingColors.primaryGreen, "+2.98%",
                              "Vs Previous Day", Colors.green, theme),
                          const SizedBox(height: 12),
                          _buildStatItem(DatingColors.darkGreen, "-28.02%",
                              "Vs Previous Day", Colors.red, theme),
                          const SizedBox(height: 12),
                          _buildStatItem(DatingColors.lightGreen, "-38.02%",
                              "Vs Previous Day", Colors.red, theme),
                        ],
                      ),
                    )
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text('All', style: theme.textTheme.bodyMedium?.copyWith(color: Colors.white)),
                      ),
                    ),
                    const SizedBox(width: 8),
                    Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, '/addprofilescreen');
                      },
                      child: Container(
                        width: 40,
                        height: 40,
  ...
  Widget _buildStatItem(Color dotColor, String value, String label, Color textColor, ThemeData theme) {
    return Row(
      children: [
        Container(
          width: 10,
  ...
  Widget _iconButton(IconData icon, Color bgColor, ThemeData theme) {
    return Container(
      padding: const EdgeInsets.all(8),
      decoration: BoxDecoration(
        color: bgColor,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                      ...
                      Row(
                        children: [
                          Icon(
                            isVerified ? Icons.verified : Icons.error,
                            size: 16,
                            color: isVerified ? DatingColors.darkGreen : theme.colorScheme.error,
                          ),
                          const SizedBox(width: 4),
                          Text(
                            status,
                  ...
                  Row(
                    children: [
                      _iconButton(Icons.list, DatingColors.accentTeal, theme),
                      const SizedBox(width: 8),
                      _iconButton(Icons.edit, DatingColors.successGreen, theme),
                      const SizedBox(width: 8),
                      _iconButton(Icons.close, DatingColors.errorRed, theme),
                    ],
                  )
                ],
              ),
...
class MultiLayerCircle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(
      size: const Size(150, 150),
      painter: CircleGraphPainter(theme),
    );
  }
}
