...
class Languagespostscreen extends ConsumerStatefulWidget {
  const Languagespostscreen({super.key});

  @override
  ConsumerState<Languagespostscreen> createState() =>
      _LanguagespostscreenState();
}

class _LanguagespostscreenState
    extends ConsumerState<Languagespostscreen> {
  ...
  void _handleSubmit() async {
    ...
    if (_editingId == null) {
      ...
      await ref.read(languagesProvider.notifier).addLanguages(languages:_textController.text);
      ...
      await ref.read(languagesProvider.notifier).updateLanguages(_editingId!, text);
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(_editingId == null ? "Add languages" : "Edit languages"),
      ),
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    _editingId == null ? "Add languages" : "Update languages",
