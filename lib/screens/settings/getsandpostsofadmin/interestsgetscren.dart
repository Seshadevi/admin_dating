...
class interestsGetScreen extends ConsumerStatefulWidget {
  const interestsGetScreen({super.key});

  @override
  ConsumerState<interestsGetScreen> createState() =>
      _interestsGetScreenState();
}

class _interestsGetScreenState extends ConsumerState<interestsGetScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    final dataList = interestsState.data ?? [];
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: interestsState.success == false
  ...
  onPressed: () async {
    ...
    if (confirm == true) {
      await ref.read(interestsProvider.notifier).deleteInterest(item.id);
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/interestpost');
                  },
                  child: const Text(
                    "Add",
