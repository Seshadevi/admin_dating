...
class Modepostscreen extends ConsumerStatefulWidget {
  const Modepostscreen({super.key});

  @override
  ConsumerState<Modepostscreen> createState() =>
      _ModepostscreenState();
}

class _ModepostscreenState
    extends ConsumerState<Modepostscreen> {
  ...
  void didChangeDependencies() {
    ...
    if (args != null) {
      ...
      _textController.text = args['modes'] ?? '';
    }
  }
  ...
  void _handleSubmit() async {
    ...
    if (_editingId == null) {
      ...
      await ref.read(modesProvider.notifier).addMode(modes:_textController.text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(_editingId == null ? "Add Modes" : "Edit Modes"),
      ),
      body: SafeArea(
        child: Padding(
            ...
            children: [
              ...
              Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      _editingId == null ? "Add mode" : "Update Mode",
