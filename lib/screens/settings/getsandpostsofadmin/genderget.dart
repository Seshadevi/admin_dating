...
class GenderGetScreen extends ConsumerStatefulWidget {
  const GenderGetScreen({super.key});

  @override
  ConsumerState<GenderGetScreen> createState() =>
      _GenderGetScreenState();
}

class _GenderGetScreenState extends ConsumerState<GenderGetScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    final dataList = genderState.data ?? [];
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: genderState.success == false
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/genderpost');
                  },
                  child: const Text(
                    "Add",
