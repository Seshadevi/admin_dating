...
class LookingForGetScreen extends ConsumerStatefulWidget {
  const LookingForGetScreen({super.key});

  @override
  ConsumerState<LookingForGetScreen> createState() =>
      _LookingForGetScreenState();
}

class _LookingForGetScreenState extends ConsumerState<LookingForGetScreen> {
  @override
  void initState() {
    super.initState();
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: lookingState.success == false
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/lookingforpost');
                  },
                  child: const Text(
                    "Add",
