...
class LanguagesGetScreen extends ConsumerStatefulWidget {
  const LanguagesGetScreen({super.key});

  @override
  ConsumerState<LanguagesGetScreen> createState() =>
      _LanguagesGetScreenState();
}

class _LanguagesGetScreenState extends ConsumerState<LanguagesGetScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    final dataList = languagesState.data ?? [];
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: languagesState.success == false
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: ()async {
                                        ...
                                        await ref.read(languagesProvider.notifier).deleteLanguages(item.id);
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/languagespost');
                  },
                  child: const Text(
                    "Add",
