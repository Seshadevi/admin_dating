...
class QualitiesGetScreen extends ConsumerStatefulWidget {
  const QualitiesGetScreen({super.key});

  @override
  ConsumerState<QualitiesGetScreen> createState() =>
      _QualitiesGetScreenState();
}

class _QualitiesGetScreenState extends ConsumerState<QualitiesGetScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    final dataList = qualitiesState.data ?? [];
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: qualitiesState.success == false
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/qualitiespost');
                  },
                  child: const Text(
                    "Add",
