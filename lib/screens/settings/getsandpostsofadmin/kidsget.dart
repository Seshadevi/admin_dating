...
class kidsGetScreen extends ConsumerStatefulWidget {
  const kidsGetScreen({super.key});

  @override
  ConsumerState<kidsGetScreen> createState() =>
      _kidsGetScreenState();
}

class _kidsGetScreenState extends ConsumerState<kidsGetScreen> {
  @override
  void initState() {
    super.initState();
  ...
  onPressed: () async {
    ...
    if (confirm == true) {
      await ref.read(kidsProvider.notifier).deletekids(item.id);
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/kidspost');
                  },
                  child: const Text(
                    "Add",
