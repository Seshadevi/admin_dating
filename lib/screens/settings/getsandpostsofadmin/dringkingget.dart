...
class DrinkingGetScreen extends ConsumerStatefulWidget {
  const DrinkingGetScreen({super.key});

  @override
  ConsumerState<DrinkingGetScreen> createState() =>
      _DrinkingGetScreenState();
}

class _DrinkingGetScreenState extends ConsumerState<DrinkingGetScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    final dataList = drinkingState.data ?? [];
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: drinkingState.success == false
  ...
  onPressed: () async {
    ...
    if (confirm == true) {
      await ref.read(drinkingProvider.notifier).deleteDrinking(item.id);
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/drinkingpost');
                  },
                  child: const Text(
                    "Add",
