...
class StarsignGetScreen extends ConsumerStatefulWidget {
  const StarsignGetScreen({super.key});

  @override
  ConsumerState<StarsignGetScreen> createState() =>
      _StarsignGetScreenState();
}

class _StarsignGetScreenState extends ConsumerState<StarsignGetScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    final dataList = starsignState.data ?? [];
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: starsignState.success == false
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/starsignpost');
                  },
                  child: const Text(
                    "Add",
