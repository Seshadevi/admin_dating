...
Future<int> updateLanguages(int? languagesId, String? languagesName) async {
    final loadingState = ref.read(loadingProvider.notifier);
    final prefs = await SharedPreferences.getInstance();
    ...
    try {
     ...
     final String apiUrl = "${Dgapi.updateLanguage}/$languagesId";
...
Future<int> deleteLanguages(int? languagesId) async {
  final loadingState = ref.read(loadingProvider.notifier);
  loadingState.state = true;

  try {
    final String deleteUrl = "${Dgapi.deleteLanguage}/$languagesId";
