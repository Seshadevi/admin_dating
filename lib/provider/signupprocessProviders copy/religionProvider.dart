...
Future<int> updateREligion(int? religionId, String? religionName) async {
    final loadingState = ref.read(loadingProvider.notifier);
    final prefs = await SharedPreferences.getInstance();
    ...
    try {
     ...
     final String apiUrl = "${Dgapi.updateReligion}/$religionId";
      ...
      final body = jsonEncode({
        // "user_id": userId,
        "religion": religionName, // List of IDs
      });
...
Future<int> deleteReligion(int? religionId) async {
  final loadingState = ref.read(loadingProvider.notifier);
  loadingState.state = true;

  try {
    final String deleteUrl = "${Dgapi.deleteReligion}/$religionId";
