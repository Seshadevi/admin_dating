...
class Dgapi {
  ...
  static const String updateverification =
      "$baseUrl/admin/users/userId/verification";
  // static const String  admincreatedusers= "$baseUrl/admin/admincreatedusers";
  static const String admincreatedusers =
      "$baseUrl/superAdmin/getfakeusersforadmin";
  static const String fakeuserdelete = "$baseUrl/admin/deleteBotusers";
